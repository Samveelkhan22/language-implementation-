...
def parse_initialization(initialization):
    pattern = r'^Afeeler Var (int|float|char|string) ([a-zA-Z_]\w*) = (([-]?[0-9]+(\.[0-9]+)?)|([\'"].*?[\'"]))$'
...
def main():
    text = 'Afeeler Var int a = 10; Afeeler Var float b = 10.0; Afeeler Var char c = \'A\'; Afeeler Var string d = "Hello";'
